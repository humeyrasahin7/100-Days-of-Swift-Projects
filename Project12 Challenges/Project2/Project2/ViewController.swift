...
class ViewController: UIViewController {
    ...
    var highest = 0 {
        didSet {
            highLabel.text = "High Score: \(highest)"
        }
    }
    ...
    override func viewDidLoad() {
        ...
        if let highScore = userDefaults.object(forKey: "highest") as? Int{
            self.highest = highScore
        } else {
            highest = score
        }
    ...
    @IBAction func buttonTapped(_ sender: UIButton) {
        ...
        if tag == correctAnswer{
            ...
            if score > highest{
                highest = score
                let ac = UIAlertController(title: "congrats!", message: "you beat the high score!", preferredStyle: .alert)
        ...
        userDefaults.set(highest, forKey: "highest")
