...
//  Project27
//
//  Created by Hümeyra Şahin on 16.11.2021.
//
...
class ViewController: UIViewController {
    ...
    func drawRectangle(){
        ...
        let image = renderer.image { ctx in
            //drawing code
            let rectangle = CGRect(x: 0, y: 0, width: 500, height: 500)
    ...
    func drawCircle(){
        ...
        let image = renderer.image { ctx in
            //drawing code
            let rectangle = CGRect(x: 0, y: 0, width: 500, height: 500).insetBy(dx: 5, dy: 5)
